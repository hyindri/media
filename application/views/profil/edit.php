			...
			<div class="card">
				...
				<div class="body">
					<form action="{{site_url('profil/updatedata')}}" method="POST">
						...
						<div class="form-group">
							<div class="form-line">
								<input type="text" id="tipe_media_massa" class="form-control" placeholder="Masukkan Penawaran Kerja Sama" name="tipe_media_massa" value="{{$data_profil->tipe_media_massa}}">
							</div>
						</div>
						<a class="deco-off btn bg-red col-white m-t-15 waves-effect" href="{{site_url('profil')}}">
							BATAL
						</a>
						<button type="submit" class="btn bg-green col-white m-t-15 waves-effect">SIMPAN</button>
					</form>
				</div>
			</div>
		</div>
