            ...
            <div class="row p-t-10">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <?php echo form_open_multipart(site_url('auth/signup'), array('id' => 'wizard_with_validation', 'method' => 'POST', 'autocomplete' => 'off')); ?>
                            ...
                            <fieldset>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="password" class="form-control" name="password" id="password" minlength="8" required title="Isi password minimal 8 karakter"> 
                            ...
                            <fieldset>
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="npwp" value="<?php echo set_value('npwp'); ?>" minlength="15" maxlength="15" required  title="Isi npwp minimal 15 karakter">
                                ...
                                <div class="form-group form-float">
                                    <div class="form-line">
                                        <input type="text" class="form-control" name="no_telp" value="<?php echo set_value('no_telp'); ?>" minlength="11" maxlength="12" required  title="Isi nomor telp minimal 11 karakter">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                ...
                                                <label class="form-label">Username Akun Facebook*</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                ...
                                                <label class="form-label">Username Akun Instagram*</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                ...
                                                <label class="form-label">Username Akun Twitter*</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group form-float">
                                            <div class="form-line">
                                                ...
                                                <label class="form-label">Channel Youtube*</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
        ...
        $(function() {
            ...
            form.steps({
                ...
                onInit: function(event, currentIndex) {
                    ...
                    $("[name='npwp']").inputFilter(function(value) {
                        return /^\d*$/.test(value); // Allow digits only, using a RegExp
                    });

                    $("[name='rekening']").inputFilter(function(value) {
                        return /^\d*$/.test(value); // Allow digits only, using a RegExp
                    });

                    $("[name='no_telp']").inputFilter(function(value) {
                        return /^\d*$/.test(value); // Allow digits only, using a RegExp
                    });

                    $("[name='jumlah_saham']").inputFilter(function(value) {
                        return /^\d*$/.test(value); // Allow digits only, using a RegExp
                    });
                    ...
                    $("[name='username_ig']").on('keypress', function(e) {
                        if (e.which == 32) {
                            return false;
                        }
                    });

                    $("[name='username_twitter']").on('keypress', function(e) {
                        if (e.which == 32) {
                            return false;
                        }
                    });
